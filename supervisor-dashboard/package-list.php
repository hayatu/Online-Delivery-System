...
<?php
	...
	$conn = db_connect();	
	  ...
	  $query1 = sprintf("select *, COUNT(*) as total,SUM(pickupprice) as pricesum from tbl_package_info  where deleteflag = 0 and assign_status = 0 group by zone_name" );
			...
			<tbody>
				<?php
					...
					<tr class="alert-info">
                       ...
                       <td><a href="package-list-details.php?zone-name=<?php echo $rs_package[$i]["zone_name"]; ?>" class="btn btn-sm" role="button"><i class="fas fa-edit"></i></a></td>							
