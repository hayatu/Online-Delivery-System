...
$conn = db_connect();
			...
			// insert 
			  $query1 = sprintf("insert into tbl_package_info(customer_id,track_num,weight, criteria,quantity,description,pickupprice,is_fragile,zone_name,city_name,first_name, last_name,email, mobile, 
			 address,country_id,c_first_name,c_last_name,c_email,c_mobile,c_address,c_country_id,current_loc,destination,departure_time) values(%s, %s, %s,%s, %s,%s,%s,%s,%s,%s, %s, %s, %s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", 
			 	GetSQLValueString($_REQUEST["customer_id"], "int"),
