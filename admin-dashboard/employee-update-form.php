...
<main class="pl-1 pt-1">
    <div class="container">
		...
		<input name="emp-id" type="hidden" id="emp-id" value="<?php echo $rs_supervisor[0]["emp_id"]; ?>">
                ...
                <div class="col-md-4 mb-4">
                    <div>
                        ...
                        <select name="vehicle_id" class=" form-control" required>
							...
							for($i=0; $i<$n2; $i++){
							?>
							<option value="<?php echo $rs_vehicle[$i]["vehicle_id"]; ?>"<?php if($rs_vehicle[$i]["vehicle_id"] == $rs_supervisor[0]["vehicle_id"]) echo " selected"; ?>><?php echo $rs_vehicle[$i]["plat_number"]; ?></option>
							<?php 
							} 
							?>
						</select>
