...
<main class="pl-1 pt-1">
	<div class="container">
			...
			<div class="col-md-4">
				...
				<a href="unavailable-employee-list.php"><span class="font-weight-bold">Unavailable Employees</span></a>					
				</div>
			</div>			
			</div>
		<table id="dtBasicExample" class="table table-bordered" cellspacing="0" width="100%">
			...
			<tbody>
				<?php
					for($i=0; $i<$n; $i++){
					?>
					<tr <?php if(($rs_employee[$i]["v_available"]=='Yes')){ echo "class='alert alert-success' role='alert';"; }								
						...
						<td><a href="employee-vehicle-update-form.php?emp-id=<?php echo $rs_employee[$i]["vehicle_id"]; ?>" class="btn btn-sm" role="button"><i class="fas fa-edit"></i></a></td>	
