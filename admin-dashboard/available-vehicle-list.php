...
<?php
	...
	$conn = db_connect();	
       $query1 = sprintf("select * from tbl_vehicle_info where deleteflag = 0 and is_available ='Yes' order by made_model");
	...
	<div class="container">
		...
		<div class="row p-1">
			...
			<div class="col-md-4">
				...
				<a href="available-vehicle-list.php"><span class="font-weight-bold">Available Vehicles (<?php echo $n; ?>)</span></a>					
				</div>
			</div>
			<div class="col-md-4">
