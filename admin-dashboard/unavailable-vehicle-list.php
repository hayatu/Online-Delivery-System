...
<?php
	...
	$conn = db_connect();	
       $query1 = sprintf("select * from tbl_vehicle_info where deleteflag = 0 and is_available ='No' order by made_model");
	...
	<div class="container">
		...
		<div class="row p-1">
			...
			<div class="col-md-4">
				...
				<a href="unavailable-vehicle-list.php"><span class="font-weight-bold">Unavailable Vehicles (<?php echo $n; ?>)</span></a>					
				</div>
			</div>
			<div class="col-md-4">
				<div class="alert alert-danger p-1 text-center" role="alert">
				<a href="vehicle-list.php"><span class="font-weight-bold">Go Back Vehicles List</span></a>					
				</div>
			</div>		
			</div>
