...
<?php
	...
	$conn = db_connect();	
        ...
        $query1 = sprintf("select pack.package_id, pack.emp_id, pack.track_num, pack.weight,pack.quantity,pack.is_fragile, pack.current_loc,
					...
					pack.commnts, pack.city_name, pack.createdate,pack.modifieddate,pack.vehicle_id, pack.c_first_name, pack.c_last_name,pack.c_mobile,
	...
	."where pack.emp_id = %s and pack.deleteflag = 0 and assign_status = 1 and pack.status_id != 2 and pickedby = 0 order by pack.weight, tbl_employee_info.first_name ASC",
