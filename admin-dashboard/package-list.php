...
<?php
	...
	$conn = db_connect();	
	  ...
	  $query1 = sprintf("select *, COUNT(*) as total,SUM(pickupprice) as pricesum from tbl_package_info  where deleteflag = 0 and assign_status = 0 group by zone_name ORDER BY package_id DESC" );
...
<main class="pl-1 pt-1">
	<div class="container">
		...
		<div class="row">
		<div class="col-md-3">
				<a href="customer-list.php" class="btn btn-primary btn-block font-weight-bold" role="button"> Add (<i class="fas fa-plus"></i>) New Package</a>
			</div>	
			<div class="col-md-3">
			...
			<div class="row pt-3">
		<div class="col-md-3">
				<a href="delivered-package-list.php" class="btn btn-primary btn-block font-weight-bold" role="button"> Delivered Package List</a>				
			</div>
				</div>
			<thead>
				...
				<th class="th-sm">Truck Number
					...
					<th class="th-sm">Total Pickup Price
					</th>
			...
			<tbody>
				<?php
					...
					<tr class="alert-info">
						...
						<td><?php echo $rs_package[$i]["pricesum"]."$"; ?></td>	
						...
						<td><?php  $time_original = date("Y-m-d", strtotime($rs_package[$i]["createdate"]));
                       ...
                       <td><a href="package-list-details.php?zone-name=<?php echo $rs_package[$i]["zone_name"]; ?>" class="btn btn-sm" role="button"><i class="fas fa-info-circle"></i></a></td>							
