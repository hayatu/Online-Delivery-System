    ...
    <div class="container">
		...
		<input name="package-id" type="hidden" id="package-id" value="<?php echo $rs_package[0]["package_id"]; ?>">
				 <input name="assign_status" type="hidden" id="assign_status" value="1">
				  <input name="pickedby" type="hidden" id="pickedby" value="<?php echo $rs_package[0]["pickedby"]; ?>">
            ...
            <div class="col-md-4 mb-4 p-4">
			 <i class="fas fa-people-carry prefix grey-text"></i>
			 <label for="address" class="active">Decline</label>
              <!-- Default inline 1-->
						<i class="far fa-times-circle"></i>
						<div class="custom-control custom-checkbox custom-control-inline">
							<input name="accept_decline" type="checkbox" class="custom-control-input" id="declined" value="declined" <?php if($rs_package[0]["accept_decline"] == 'declined') echo " checked"; ?>>
               ...
               <!--Grid column-->
                ...
                <div class="col-md-3 mb-4">
                    <div>
                        ...
                        <label for="c_first_name" class="active">Reciever Name</label>
				...
				<div class="col-md-4 mb-4">
                    <div>
                        ...
                        <label for="delivery_time" class="active">Estimated Delivery Time</label>
						 <input name="delivery_time" type="text" class="form-control delivery_time" value="<?php echo  $rs_package[0]["delivery_time"]; ?>">
				...
				<div class="col-md-4 mb-4">
                    <div>
                        ...
                        <label for="commnts" class="active">Comments</label>
